...
def render():
    ...
    igreja_externa = get_base64_image("assets/images/externa.png") 
    igreja_interior = get_base64_image("assets/images/interior.png") 
    igreja_altar = get_base64_image("assets/images/altar.png")
