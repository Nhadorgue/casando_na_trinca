...
# CSS específico desta página (cores vêm dos tokens do theme.css)
CSS_HISTORIA = """
<style>
...
.texto-historia {
    ...
    border-bottom: 1.5px solid var(--serenity-blue-forte);
}
    ...
    with col_img:
        st.markdown(
            ...
            <div class="img-container">
                <img src="data:image/jpeg;base64,{get_base64_image(imagem)}" alt="">
            </div>
            """,
            unsafe_allow_html=True,
        )
...
def render():
    ...
    st.markdown(CSS_HISTORIA, unsafe_allow_html=True)
